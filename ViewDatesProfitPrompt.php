...
<form action="ViewDatesProfit.php" method="post">
<div class = "inputBox">
...
<div class="popup" onclick="myFunction()">Help
  <span class="popuptext" id="myPopup">
    		...
    		This is the View Profits or Losses by Date Range page.  Here you can enter two dates and view your profits or losses between them.
                    <br><br>
                    
                    Here you are prompted for info pertaining to the dates you would like to look up profits or losses for:  <br><br>
