...
<br><br><br><br>
<div><button class="submit" type="button" onclick="window.location.href='ViewSingleDateBoughtPrompt.php'"> Back </div>
...
<div class="popup" onclick="myFunction()">Help
  <span class="popuptext" id="myPopup">
    		...
    		Displayed is the information regarding your date search.  The expenses that were earned on the date you entered will appear here.  If no purchases were found for that date, please refer to the View all Expenses page.
                    <br><br>
