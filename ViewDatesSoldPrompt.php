...
<form action="ViewDatesSold.php" method="post">
<div class = "inputBox">
...
<div class="popup" onclick="myFunction()">Help
  <span class="popuptext" id="myPopup">
    		...
    		This is the View Revenue by Date Range page.  Here you can enter two dates and view your revenues between them.
                    <br><br>
                    
                    Here you are prompted for info pertaining to the dates you would like to look revenue up for:  <br><br>
