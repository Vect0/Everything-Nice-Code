...
<h2><u>Here are all of the sold items:</u></h2><br>
...
$result = mysqli_query($evdb, "SELECT * FROM inventory WHERE Sold > 0");
    ...
    . $row["BuyPrice"]. " - SellPrice: ". $row["SellPrice"]. " - Sold: ". $row["Sold"].
...
<div class="popup" onclick="myFunction()">Help
  <span class="popuptext" id="myPopup">
    		...
    		This is the View Sold page.  Displayed is all of the inventory that contain items that have been sold.  
                    <br><br>
